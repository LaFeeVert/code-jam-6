...
class ViewControl():
    ...
    def look(self, direction):
        ...
        if direction == Directions.NORTH:
            ...
            forward_view = list(reversed(self.visible_block[2]))
        ...
        # print(f'Looking {direction} {forward_view}')
        # print(self.current_location)
        # print(self.did_bonk)
        # for v in self.visible_block:
        #     print(v)
        ...
        if forward_view[2] == 0:
            ...
            self.view_description += f'a {forward_view[2]}.\n'
